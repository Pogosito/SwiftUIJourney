...
struct ArticleWithContent: Identifiable {
		...
		NavigationStack {
			List(articles) { article in
				ZStack {
					...
					NavigationLink {
						ArticleDetailedView(articleWithContent: article)
					} label: {
...
struct Exercise_11_1Previews: PreviewProvider {
