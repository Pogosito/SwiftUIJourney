//
//  ModalViewsFloatingButtonsAlerts.swift
//  LongSwiftUJourney
//
	...
	var body: some View {
		NavigationStack {
			...
			.fullScreenCover(item: $selectedArticle) { article in
				ArticleDetailedViewWithDismissButton(articleWithContent: article)
			}
...
struct ModalViewsFloatingButtonsAlerts_Previews: PreviewProvider {

	static var previews: some View {
		ModalViewsFloatingButtonsAlerts()
	}
}
